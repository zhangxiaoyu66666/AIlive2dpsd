...
internal object PortableFilePicker : FilePickerBackend {
    override fun show(request: FilePickerRequest, owner: Window?): String? {
        ...
        val mode = if (request.kind == FilePickerKind.SAVE_PROJECT) FileDialog.SAVE else FileDialog.LOAD
        ...
        return try {
            ...
            dialog.setFilenameFilter { _, name -> request.extension == null || name.endsWith(".${request.extension}", true) }
